 ...
 */
class getMotifrefusRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MotifrefusRepository' shared autowired service.
     *
     * @return \App\Repository\MotifrefusRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MotifrefusRepository.php';

        return $container->privates['App\\Repository\\MotifrefusRepository'] = new \App\Repository\MotifrefusRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
