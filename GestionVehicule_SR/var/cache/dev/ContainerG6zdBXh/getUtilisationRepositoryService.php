 ...
 */
class getUtilisationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UtilisationRepository' shared autowired service.
     *
     * @return \App\Repository\UtilisationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UtilisationRepository.php';

        return $container->privates['App\\Repository\\UtilisationRepository'] = new \App\Repository\UtilisationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
