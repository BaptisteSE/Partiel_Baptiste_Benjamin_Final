...
class Vehicule extends \App\Entity\Vehicule implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Vehicule' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Vehicule' . "\0" . 'immatriculation', '' . "\0" . 'App\\Entity\\Vehicule' . "\0" . 'utilisations'];
        }
     ...
     * {@inheritDoc}
     */
    public function getDestination(): \Doctrine\Common\Collections\Collection
    {
     ...
     * {@inheritDoc}
     */
    public function addDestination(\App\Entity\Utilisation $destination): \App\Entity\Vehicule
    {
     ...
     * {@inheritDoc}
     */
    public function removeDestination(\App\Entity\Utilisation $destination): \App\Entity\Vehicule
    {
